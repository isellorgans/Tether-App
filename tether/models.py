...
class MatchPlayers(models.Model):
    ...
    player3_id = models.BigIntegerField()
    player1_id = models.BigIntegerField()
    player4_id = models.BigIntegerField()
    player2_id = models.BigIntegerField()
    player7_id = models.BigIntegerField()
    player8_id = models.BigIntegerField()
    player9_id = models.BigIntegerField()
    player6_id = models.BigIntegerField()
    player5_id = models.BigIntegerField()
